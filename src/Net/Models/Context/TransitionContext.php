...
class TransitionContext
{
     ...
     * @param mixed $value
     */
    public static function set(string $variableName, $value): TransitionContext
    {
        return new TransitionContext(self::TAG_SET, $variableName, ['value' => $value]);
    }

    public static function get(string $variableName): TransitionContext
    {
        return new TransitionContext(self::TAG_GET, $variableName);
    }
